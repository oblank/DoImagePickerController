...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "oblank"
  # s.authors            = { "oblank" => "dyh1919@gmail.com" }
  # s.social_media_url   = "http://twitter.com/oblank"
  ...
  s.source       = { :git => "https://github.com/oblank/DoImagePickerController.git", :commit => "7ffcdd17dc866649f0e32e0220b64e314eee5b7e" }
  ...
  s.source_files  = "ImagePicker", "ImagePicker/DoImagePicker/*.{h,m,xib}"
